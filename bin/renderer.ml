...
let render_header _uri _title =
  El.div
    ~at:[ At.id "header" ]
    [
      El.div [ El.a ~at:[ At.href "/" ] [ El.div ~at:[ At.class' "logo" ] [] ] ];
      El.div
        [
          El.h1 [ El.txt "Tech notes by Michael Winston Dales" ];
          El.nav
            [
              El.ul
                ~at:[ At.id "headernav" ]
                (List.map
                   (fun (url, label) ->
                     El.li [ El.a ~at:[ At.href url ] [ El.txt label ] ])
                   [
                     ("/", "Home");
                     ("/blog/", "Blog");
                     ("/projects/", "Projects");
    ...
    List.map
      (fun sec ->
        El.li
          [
            El.a
              ~at:[ At.href (Uri.to_string (Section.uri sec)) ]
      ...
      [
        El.div
          ...
          [
            ...
            El.div
              ~at:[ At.class' "page" ]
              [ topbar; El.div ~at:[ At.id "content" ] [ El.ul secs ] ];
            El.div ~at:[ At.id "footer" ] [];
            El.div
